/**
 * @Author: Yunkai Xia
 * @Date:   2022-09-08 10:49:28
 * @Last Modified by:   Yunkai Xia
 * @Last Modified time: 2022-09-28 10:11:05
 */
#ifndef _THINNING
#define _THINNING
...
/**
 * @brief Perform one thinning iteration.(Normally you wouldn't call this
 * function directly from your code)
 * @param im    Binary image with range = [0,1]
 * @param iter  0=even, 1=odd
 */
void sceletonize_iteration(cv::Mat &img, int iter);
/**
 * @brief Function for thinning the given binary image	(Paper Zhang-Suen
 * Thinning)
 ...
 * @param dst 	the destination image containing 0 for non voronoi graph pixels
 * (else voronoigraph) (Mat uint8_t)
 */
...
/**
 * @brief function for finding the maximum Neighbour ignoring the last detected
 * pixels
